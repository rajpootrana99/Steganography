...
SECRET_KEY = 'django-insecure-(5p*15h^oivxl(1k%nsoqj*t$5k^1rlww&0@m-ury3z&6ygkmh'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'public/media')  # Adjusted path for media files
